...
%%% Колонтитулы %%%
\usepackage{datetime}	% Для подключения текущей даты
\usepackage{nameref}	% Для определения названия текущего раздела
\makeatletter
...
\renewcommand{\@oddhead}{\it \vbox{\hbox to \textwidth%
    ...
    {\today \hfil \thesection~\currentname\strut}\hrule}}
\makeatother
