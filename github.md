...
Описаную ниже схему можно использовать для того, чтобы писать свою
...
этого шаблон понявится в списке репозиториев уже вашей учётной
записи.
...
поле ввода вы видете надпись "Filter branches/tags" - вы в чужой копии
репозитория.

3) Дальше можно клонировать шаблон к себе на компьютер. Делать это
надо из **СВОЕЙ** копии шабона!
...
заменяем свой файл на исправленный, прям на сайте делаем compare,
