...
Для правильной сортировки работ можно откоментировать строку `defernumbers=true,` в файле
[biblio/biblatex.tex](biblio/biblatex.tex), но это замедлит сборку документа.
