...
\section{\label{sec:markup} Рецензирование текста}

В шаблоне заданы команды рецензирования. Они видны при компиляции шаблона в
режиме черновика или при установки соответствующей настройки в файле
\verb+common/setup.tex+.
