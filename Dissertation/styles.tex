...
%% Если раскомментировать следующие две строки, то будет вписано слово Глава перед каждым номером раздела в оглавлении (не забыть включить аналогичное в заголовках разделов в самом тексте)        
%\renewcommand{\cftchappresnum}{\chaptername\ }
%\setlength{\cftchapnumwidth}{\widthof{\textbf{\chaptername\ }}}

%\renewcommand\cftchapaftersnum{.}       % добавляет точку после номера раздела в оглавлении
%\renewcommand\cftsecaftersnum{.}        % добавляет точку после номера подраздела в оглавлении
%\renewcommand\cftsubsecaftersnum{.}     % добавляет точку после номера подподраздела в оглавлении
